...
% function of a linear regression model using LASSO
%
...
[cost, grad] = lassoCostGrad(dataX, dataY, B, lambda);
numGrad = computeNumericalGradient( @(t) lassoCostGrad(dataX, dataY, t, lambda), B );
